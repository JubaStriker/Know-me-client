                    ...
                    <div className="px-4 py-2">
                        <div className="rounded relative">
                            <div className='  bg-white'>
                                <div>
                                    <h1 className='text-center text-6xl font-semibold'>Notifications</h1>
                                </div>
                                <div className="flex justify-center h-screen items-center py-12">

                                    <div>
                                        <p className="text-primary font-semibold text-2xl md:text-6xl text-center tracking-wide">
                                            COMING S
                                        </p>
                                    </div>
                                    ...
                                    <div className="rounded-full ml-2 bg-indigo-100 w-[48px] h-[48px] relative flex justify-center items-center animate-spin">
                                        <svg
                                            className="absolute"
                                            width={48}
                                            height={48}
